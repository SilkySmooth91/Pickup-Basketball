...
export default function Footer({ showAboutLink }) {  return (
    <footer className="bg-transparent p-4">
      <div className="container mx-auto px-4">
        <div className="bg-white/95 backdrop-blur-sm rounded-lg shadow-lg border border-orange-100 mx-auto max-w-4xl   p-4 transform hover:translate-y-[-5px] transition-all duration-300 hover:shadow-2xl">
          <div className="flex flex-col md:flex-row items-center justify-between">            
            ...
            <div className="flex flex-col md:flex-row items-center">
              ...
              {showAboutLink && (
                <Link to="/about" className="md:ml-7 text-orange-500 hover:text-orange-700 transition-colors flex items-center mt-1 md:mt-0">
