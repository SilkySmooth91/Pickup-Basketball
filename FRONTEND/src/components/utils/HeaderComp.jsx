  ...
  const navLinks = (
    <ul className="flex flex-col md:flex-row justify-center text-base font-medium">
      <li className="inline-block">
        <Link to="/map" className="relative hvr-bounce-to-bottom px-4 py-2 rounded transition-colors" onClick={() => setMobileMenuOpen(false)}>Mappa</Link>
      </li>
      <li className="inline-block">
        <Link to="/events" className="relative hvr-bounce-to-bottom px-4 py-2 rounded transition-colors" onClick={() => setMobileMenuOpen(false)}>Eventi vicino a te</Link>
      </li>
      <li className="inline-block">
        <Link to="/players" className="relative hvr-bounce-to-bottom px-4 py-2 rounded transition-colors" onClick={() => setMobileMenuOpen(false)}>Cerca giocatori</Link>
      </li>
      <li className="inline-block">
        <Link to="/about" className="relative hvr-bounce-to-bottom px-4 py-2 rounded transition-colors" onClick={() => setMobileMenuOpen(false)}>About</Link>
      </li>
    </ul>
  );
